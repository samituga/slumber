...
class HttpRequestMapperTest { // TODO: 18/04/2023 Move this to HttpRequestTest class
    ...
    void should_map_correctly() throws IOException {
        ...
        var queryParam1 = entry("one-query", Set.of("one-query"));
        var queryParam2 = entry("two-query", Set.of("two-query"));
        ...
        assertThat(result.pathParams()).isEqualTo(PathParams.of(pathParamMap));
        assertThat(result.queryParams()).isEqualTo(QueryParams.of(queryParamMap));
