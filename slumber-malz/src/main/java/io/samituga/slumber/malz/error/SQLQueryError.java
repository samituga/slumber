...
public class SQLQueryError extends Error {
    ...
    public SQLQueryError(String condition) { // TODO: 01/01/2023 Generalize
        super(String.format(FIND_ONE_ERROR.format(), condition)); // TODO: 01/01/2023 Why FIND_ONE_ERROR?
    }
